        ...
        >
            ...
            {!isLive && (
                <motion.div
                    ...
                    className={`absolute top-3 left-1/2 -translate-x-1/2 z-20 px-3 py-1.5 rounded-full text-xs font-bold shadow-lg backdrop-blur-md flex items-center gap-1.5 ${
                        isBestMatch
                ...
                >
                    {isBestMatch ? "🏆 Best Match" : `✦ Score ${bestMatchScore}`}
                </motion.div>
            )}
            ...
            <div className="p-5 relative">
                ...
                <div className="flex items-start justify-between gap-2 mb-2">
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-white line-clamp-1 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300">
                        {title}
                    </h3>
                </div>
                ...
                {/* Details */}
                <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 pt-3 border-t border-gray-100 dark:border-slate-800">
